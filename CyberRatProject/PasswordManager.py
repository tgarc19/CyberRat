...
master_password = None  # use global to refer to this
...
def set_master_password_from_gui(entry_field, root, login_frame, main_frame):
    global master_password
    master_password = entry_field.get()
